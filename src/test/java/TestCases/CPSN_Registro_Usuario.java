    ...
    public void CPSN_Registro_Usuario() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                    ...
                    this.registroUsuariosSteps.ingresarDatosUsuarioNuevo(driver, sucursal, puesto, nomina, papellido, pnombre, snombre, papellido, sapellido, contrasena, usuarioAutoriza, contrasenaAutoriza, UIRegistro, Config, contador, Escenario, Navegador);
