    ...
    public void CPSN_Registro_Socio() throws InterruptedException, DocumentException, BadElementException, IOException, Exception {
        ...
        while((filaDatos = DataDriven.readNext()) != null){
            ...
            try{
                ...
                //Paso 3
                contador++;
                Pasos.add(contador+".- Ingresar los datos del registro = Primer Nombre: "+pnombre+", Segundo Nombre: "+snombre+", Primer Apellido: "+papellido+", Segundo Apellido: "+sapellido+", Contraseña: "+contrasena+", Usuario Autoriza: "+usuarioAutoriza+", Contraseña Usuario Autoriza: "+contrasenaAutoriza+".");
